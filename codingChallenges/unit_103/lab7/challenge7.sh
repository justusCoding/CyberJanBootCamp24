...
echo "enter a File/Folder path"
ls
read userFile

echo "enter Permissions Number (e.g. 775 to perform a chmod 775)"

read userPermNum

chmod $userPermNum $userFile 
echo "congrats you granted permission to $userFile"
ls -l $userFile
