...
import random
secret_number = random.randint(0,4) 
muggleNum = int(input("guess the secrect number between 0-100. Those who don't guess the number will be stuck in an endless loop forever! "))
while muggleNum != secret_number: 
    print("Ha ha! You're stuck in my loop!") 
    print(muggleNum) 
    muggleNum = int(input("try again: "))
    
print(f"Well done, muggle! You are free now. your number was {muggleNum}, the secret number is {secret_number}")