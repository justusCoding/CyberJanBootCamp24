...
# Try to print a string and an integer together on one line, e.g., 
...
total_apples = sum((john,mary,adam))

print(total_apples)
print(f"{john},{mary},{adam}")

print(f"the the total number of apples {total_apples}")

print(total_apples/john)
print(total_apples//adam)
print(total_apples * mary)